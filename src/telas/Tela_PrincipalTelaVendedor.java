 ...
 * @author yNot
 */
public class Tela_PrincipalTelaVendedor extends javax.swing.JFrame {

    /**
     * Creates new form Tela_PrincipalTelaVendedor
     */
    public Tela_PrincipalTelaVendedor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_PrincipalTelaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_PrincipalTelaVendedor().setVisible(true);
            }
        });
    }
